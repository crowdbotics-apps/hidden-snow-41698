"""
Django settings for hidden_snow_41698 project.
...
ROOT_URLCONF = 'hidden_snow_41698.urls'
...
WSGI_APPLICATION = 'hidden_snow_41698.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_snow_41698 API",
    "DESCRIPTION": "API documentation for hidden_snow_41698 App",
    "VERSION": "v1",
}
